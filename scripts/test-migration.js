...
async function main() {
  ...
  try {
    ...
    console.log('   node backend/scripts/run-migration.js up 001_create_conversation_states');
    console.log('   node backend/scripts/test-migration.js');
    console.log('\n2. To test migration DOWN:');
    console.log('   node backend/scripts/run-migration.js down 001_create_conversation_states');
    console.log('   node backend/scripts/test-migration.js');
