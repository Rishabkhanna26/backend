 ...
 * 
 * Usage:
 *   node backend/scripts/run-migration.js up 001_create_conversation_states
 *   node backend/scripts/run-migration.js down 001_create_conversation_states
 * 
 * Requirements: 12.5
 */
...
async function main() {
  ...
  if (args.length < 2) {
    console.error('Usage: node backend/scripts/run-migration.js <up|down> <migration-name>');
    console.error('Example: node backend/scripts/run-migration.js up 001_create_conversation_states');
    process.exit(1);
  }
